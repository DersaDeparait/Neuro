...
class GeneticAlgorithmParamsTest(GeneticAlgorithmParams):
    def __init__(self) -> None:
        ...
        self.count_of_alive_after_epoch = int(self.start_population * 0.2)  # Кількість виживших пісял того як закінчився минулий раунд
        self.mutation_power = 0.02  # Ймовірність мутації гена межі [0 до 1]
        self.crossover_point_number = 1  # Кількість точко кросовера, зазвичай 1, можна до 10
